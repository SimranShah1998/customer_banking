...
def main():
    ...
    savings_interest = float(input("Enter the annual percentage rate (APR) for the savings account: "))
    ...
    cd_interest = float(input("Enter the annual percentage rate (APR) for the CD account: "))
